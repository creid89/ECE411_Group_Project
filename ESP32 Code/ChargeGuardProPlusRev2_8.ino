...
void setup() {
  ...
  //analogSetCycles(64); // Increase sampling cycles for stability
  //analogSetSamples(8); // Take 8 samples for each reading to improve accuracy
  //analogSetClockDiv(4); // Adjust clock for higher stability
